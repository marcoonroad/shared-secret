...
(* OASIS_START *)
(* DO NOT EDIT (digest: b157009977e749c6d64fdb6ebabac1db) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$exceptional", []))];
          ...
          ("applicative",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$applicative", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Marco Aur\195\169lio da Silva <marcoonroad@gmail.com>"];
          homepage = Some "http://github.com/marcoonroad/shared-secret";
            ...
            [
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "http://github.com/marcoonroad/shared-secret.git";
                      src_repo_browser =
                        Some "http://github.com/marcoonroad/shared-secret";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "exceptional.ml"});
               Executable
                 ({
                     cs_name = "applicative";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "applicative.ml"});
               Test
                 ({
                     cs_name = "exceptional";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "exceptional"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "applicative"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\166\177\137\203JwQ\189\255\133>\145\147\177=\005";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
